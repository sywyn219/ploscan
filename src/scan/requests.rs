...
use crate::com::client::{Client, SubmissionParameters};
            ...
            .and_then(move |submission_params| {
                ...
                client
                    ...
                    .then(move |res| {
                        match res {
                            Ok(res) => {
                                if submission_params.deadline != res.result.deadline {
...
mod tests {
    ...
    static BASE_URL: &str = "http://192.168.1.63:8545";
    ...
    fn test_submit_nonce() {
        ...
        let ming=request_handler.get_mining_info();
        rt.shutdown_on_idle();
    }
}
